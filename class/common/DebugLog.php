...
class DebugLog {
     ...
     *
     * @param $label string 日志标签
     * @param $params int HTTP 请求参数
     * @param $config int HTTP 配置
     * @param $mtime1 int HTTP 请求开始时间
     * @param $mtime2 int HTTP 请求结束时间
     * @param null $data array HTTP 请求数据
     * @param bool $handler
     */
